export const NL = {
    ...
    AlMine2xOutputDesc: "Aluminium mijnen produceren 2x Aluminium maar verbruiken 2x zoveel stroom",
    ...
    DowngradeBuilding: "verlaag level",
    WarehouseAddInput: "voeg een route toe",
    WarehouseTapToSelect: "raak map aan voor te seleteren...",
